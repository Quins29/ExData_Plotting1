...
## Plot2
with(DS_From_Dates, plot(Global_active_power~DateTime, type="l", xlab="",
                         ylab="Global Active Power (kilowatts)"))                               ## I Create a Graphic device for to create my Plot2
dev.copy(png, file ="plot2.png", width = 480, height = 480)                                     ## I copy my Graphic device into PNG file
dev.off()                                                                                       ## I close Graphic device and I allow register "plot2.png" file into my workspace
